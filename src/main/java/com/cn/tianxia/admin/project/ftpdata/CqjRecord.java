...
public class CqjRecord {
    ...
    public String toString() {
        return "CqjRecord [id=" + id + ", cagent=" + cagent + ", gamecode=" + gamecode + ", gametype=" + gametype
                + ", gameplat=" + gameplat + ", account=" + account + ", round=" + round + ", bet=" + bet + ", win="
                + win + ", jackpot=" + jackpot + ", jackpottype=" + jackpottype + ", winpc=" + winpc + ", balance="
                + balance + ", status=" + status + ", bettime=" + bettime + ", endroundtime=" + endroundtime
                + ", createtime=" + createtime + ", rake=" + rake + ", gamerole=" + gamerole + ", bankertype="
                + bankertype + ", jackpotcontribution=" + jackpotcontribution + ", detail=" + detail + ", getId()="
                + getId() + ", getCagent()=" + getCagent() + ", getGamecode()=" + getGamecode() + ", getGametype()="
                + getGametype() + ", getGameplat()=" + getGameplat() + ", getAccount()=" + getAccount()
                + ", getRound()=" + getRound() + ", getBet()=" + getBet() + ", getWin()=" + getWin() + ", getJackpot()="
                + getJackpot() + ", getJackpottype()=" + getJackpottype() + ", getWinpc()=" + getWinpc()
                + ", getBalance()=" + getBalance() + ", getStatus()=" + getStatus() + ", getBettime()=" + getBettime()
                + ", getEndroundtime()=" + getEndroundtime() + ", getCreatetime()=" + getCreatetime() + ", getRake()="
                + getRake() + ", getGamerole()=" + getGamerole() + ", getBankertype()=" + getBankertype()
                + ", getJackpotcontribution()=" + getJackpotcontribution() + ", getDetail()=" + getDetail()
